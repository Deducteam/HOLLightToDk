...
export_namedthm numseg "numseg";;

export_theory "numseg-thm";;
...
export_namedthm FINITE_NUMSEG "FINITE_NUMSEG";;
...
export_namedthm NUMSEG_EMPTY "NUMSEG_EMPTY";;
...
export_namedthm FINITE_SUBSET_NUMSEG "FINITE_SUBSET_NUMSEG";;
...
export_namedthm CARD_NUMSEG_LEMMA "CARD_NUMSEG_LEMMA";;
...
export_namedthm NUMSEG_CLAUSES "NUMSEG_CLAUSES";;
...
export_namedthm FINITE_INDEX_NUMSEG "FINITE_INDEX_NUMSEG";;
...
export_namedthm NUMSEG_OFFSET_IMAGE "NUMSEG_OFFSET_IMAGE";;
...
export_namedthm NUMSEG_LT "NUMSEG_LT";;
...
export_theory "numseg-topological-sort";;
...
export_namedthm TOPOLOGICAL_SORT "TOPOLOGICAL_SORT";;

(* ------------------------------------------------------------------------- *)
(* Analogous finiteness theorem for segments of integers.                    *)
(* ------------------------------------------------------------------------- *)

export_theory "intseg-finite";;
...
export_namedthm monoidal "monoidal";;
...
export_namedthm MONOIDAL_AC "MONOIDAL_AC";;

let support = new_definition 
  `support op (f:A->B) s = {x | x IN s /\ ~(f x = neutral op)}`;;

export_namedthm support "support";;
...
export_namedthm SUPPORT_SUPPORT "SUPPORT_SUPPORT";;
...
export_namedthm SUPPORT_CLAUSES "SUPPORT_CLAUSES";;
...
export_namedthm SUPPORT_DELTA "SUPPORT_DELTA";;
...
export_namedthm ITERATE_EXPAND_CASES "ITERATE_EXPAND_CASES";;
...
export_namedthm ITERATE_CLAUSES_GEN "ITERATE_CLAUSES_GEN";;
...
export_namedthm ITERATE_CLAUSES "ITERATE_CLAUSES";;
...
export_namedthm ITERATE_UNION "ITERATE_UNION";;
...
export_namedthm ITERATE_UNION_GEN "ITERATE_UNION_GEN";;
...
export_namedthm ITERATE_DIFF "ITERATE_DIFF";;
...
export_namedthm ITERATE_DIFF_GEN "ITERATE_DIFF_GEN";;
...
export_namedthm ITERATE_INCL_EXCL "ITERATE_INCL_EXCL";;
...
export_namedthm ITERATE_CLOSED "ITERATE_CLOSED";;
...
export_namedthm ITERATE_RELATED "ITERATE_RELATED";;
...
export_namedthm ITERATE_EQ_NEUTRAL "ITERATE_EQ_NEUTRAL";;
...
export_namedthm ITERATE_SING "ITERATE_SING";;
...
export_namedthm ITERATE_DELETE "ITERATE_DELETE";;
...
export_namedthm ITERATE_DELTA "ITERATE_DELTA";;
...
export_namedthm ITERATE_IMAGE "ITERATE_IMAGE";;
...
export_namedthm ITERATE_BIJECTION "ITERATE_BIJECTION";;
...
export_namedthm ITERATE_ITERATE_PRODUCT "ITERATE_ITERATE_PRODUCT";;
...
export_namedthm ITERATE_EQ "ITERATE_EQ";;
...
export_namedthm ITERATE_RESTRICT_SET "ITERATE_RESTRICT_SET";;
...
export_namedthm ITERATE_EQ_GENERAL "ITERATE_EQ_GENERAL";;
...
export_namedthm ITERATE_EQ_GENERAL_INVERSES "ITERATE_EQ_GENERAL_INVERSES";;
...
export_namedthm ITERATE_INJECTION "ITERATE_INJECTION";;
...
export_namedthm ITERATE_UNION_NONZERO "ITERATE_UNION_NONZERO";;
...
export_namedthm ITERATE_OP "ITERATE_OP";;
...
export_namedthm ITERATE_SUPERSET "ITERATE_SUPERSET";;
...
export_namedthm ITERATE_UNIV "ITERATE_UNIV_0";;
...
export_namedthm ITERATE_SWAP "ITERATE_SWAP";;
...
export_namedthm ITERATE_IMAGE_NONZERO "ITERATE_IMAGE_NONZERO";;
...
export_namedthm ITERATE_IMAGE_GEN "ITERATE_IMAGE_GEN";;
...
export_namedthm ITERATE_CASES "ITERATE_CASES";;
...
export_namedthm ITERATE_OP_GEN "ITERATE_OP_GEN";;

export_theory "iterate-finite-clauses-thm";;
...
export_namedthm ITERATE_CLAUSES_NUMSEG "ITERATE_CLAUSES_NUMSEG";;
...
export_namedthm ITERATE_CLAUSES_NUMSEG_LT "ITERATE_CLAUSES_NUMSEG_LT";;
...
export_namedthm ITERATE_CLAUSES_NUMSEG_LE "ITERATE_CLAUSES_NUMSEG_LE";;
...
export_namedthm ITERATE_PAIR "ITERATE_PAIR";;
...
export_namedthm ITERATE_REFLECT "ITERATE_REFLECT";;

(* ------------------------------------------------------------------------- *)
(* Sums of natural numbers.                                                  *)
(* ------------------------------------------------------------------------- *)

export_theory "nsum-def";;
...
export_namedthm nsum "nsum";;

export_theory "nsum-thm";;
...
export_namedthm NEUTRAL_ADD "NEUTRAL_ADD";;
...
export_namedthm NSUM_DEGENERATE "NSUM_DEGENERATE";;
...
export_namedthm NSUM_CLAUSES "NSUM_CLAUSES";;
...
export_namedthm NSUM_UNION "NSUM_UNION";;
...
export_namedthm NSUM_DIFF "NSUM_DIFF";;
...
export_namedthm NSUM_ADD_GEN "NSUM_ADD_GEN";;
...
export_namedthm NSUM_EQ_0 "NSUM_EQ_0";;

let NSUM_0 = prove 
 (`!s:A->bool. nsum s (\n. 0) = 0`,
  SIMP_TAC[NSUM_EQ_0]);;

export_namedthm NSUM_0 "NSUM_0";;
...
export_namedthm NSUM_LE "NSUM_LE";;
...
export_namedthm NSUM_LT "NSUM_LT";;
...
export_namedthm NSUM_LT_ALL "NSUM_LT_ALL";;
...
export_namedthm NSUM_EQ "NSUM_EQ";;
...
export_namedthm NSUM_CONST "NSUM_CONST";;
...
export_namedthm NSUM_POS_BOUND "NSUM_POS_BOUND";;
...
export_namedthm NSUM_EQ_0_IFF "NSUM_EQ_0_IFF";;
...
export_namedthm NSUM_POS_LT "NSUM_POS_LT";;
...
export_namedthm NSUM_DELTA "NSUM_DELTA";;
...
export_namedthm NSUM_SWAP "NSUM_SWAP";;
...
export_namedthm NSUM_IMAGE "NSUM_IMAGE";;
...
export_namedthm NSUM_SUPERSET "NSUM_SUPERSET";;
...
export_namedthm NSUM_UNIV "NSUM_UNIV";;
...
export_namedthm ITERATE_UNIV "ITERATE_UNIV";;
...
export_namedthm NSUM_UNION_RZERO "NSUM_UNION_RZERO";;
...
export_namedthm NSUM_UNION_LZERO "NSUM_UNION_LZERO";;
...
export_namedthm NSUM_RESTRICT "NSUM_RESTRICT";;
...
export_namedthm NSUM_BOUND "NSUM_BOUND";;
...
export_namedthm NSUM_BOUND_GEN "NSUM_BOUND_GEN";;
...
export_namedthm NSUM_BOUND_LT "NSUM_BOUND_LT";;
...
export_namedthm NSUM_BOUND_LT_ALL "NSUM_BOUND_LT_ALL";;
...
export_namedthm NSUM_BOUND_LT_GEN "NSUM_BOUND_LT_GEN";;
...
export_namedthm NSUM_UNION_EQ "NSUM_UNION_EQ";;
...
export_namedthm NSUM_EQ_SUPERSET "NSUM_EQ_SUPERSET";;
...
export_namedthm NSUM_RESTRICT_SET "NSUM_RESTRICT_SET";;
...
export_namedthm NSUM_NSUM_RESTRICT "NSUM_NSUM_RESTRICT";;

let CARD_EQ_NSUM = prove 
 (`!s. FINITE s ==> ((CARD s) = nsum s (\x. 1))`,
  SIMP_TAC[NSUM_CONST; MULT_CLAUSES]);;

export_namedthm CARD_EQ_NSUM "CARD_EQ_NSUM";;
...
export_namedthm NSUM_MULTICOUNT_GEN "NSUM_MULTICOUNT_GEN";;
...
export_namedthm NSUM_MULTICOUNT "NSUM_MULTICOUNT";;
...
export_namedthm NSUM_IMAGE_GEN "NSUM_IMAGE_GEN";;
...
export_namedthm NSUM_GROUP "NSUM_GROUP";;
...
export_namedthm NSUM_GROUP_RELATION "NSUM_GROUP_RELATION";;
...
export_namedthm NSUM_SUBSET "NSUM_SUBSET";;
...
export_namedthm NSUM_SUBSET_SIMPLE "NSUM_SUBSET_SIMPLE";;
...
export_namedthm NSUM_LE_GEN "NSUM_LE_GEN";;
...
export_namedthm NSUM_MUL_BOUND "NSUM_MUL_BOUND";;
...
export_namedthm NSUM_IMAGE_NONZERO "NSUM_IMAGE_NONZERO";;
...
export_namedthm NSUM_BIJECTION "NSUM_BIJECTION";;
...
export_namedthm NSUM_NSUM_PRODUCT "NSUM_NSUM_PRODUCT";;
...
export_namedthm NSUM_EQ_GENERAL "NSUM_EQ_GENERAL";;
...
export_namedthm NSUM_EQ_GENERAL_INVERSES "NSUM_EQ_GENERAL_INVERSES";;
...
export_namedthm NSUM_INJECTION "NSUM_INJECTION";;
...
export_namedthm NSUM_UNION_NONZERO "NSUM_UNION_NONZERO";;
...
export_namedthm NSUM_UNIONS_NONZERO "NSUM_UNIONS_NONZERO";;
...
export_namedthm NSUM_CASES "NSUM_CASES";;
...
export_namedthm NSUM_CLOSED "NSUM_CLOSED";;
...
export_namedthm NSUM_LE_NUMSEG "NSUM_LE_NUMSEG";;
...
export_namedthm NSUM_CLAUSES_NUMSEG "NSUM_CLAUSES_NUMSEG";;
...
export_namedthm NSUM_CLAUSES_NUMSEG_LT "NSUM_CLAUSES_NUMSEG_LT";;
...
export_namedthm NSUM_CLAUSES_NUMSEG_LE "NSUM_CLAUSES_NUMSEG_LE";;
...
export_namedthm NSUM_SWAP_NUMSEG "NSUM_SWAP_NUMSEG";;
...
export_namedthm NSUM_ADD_SPLIT "NSUM_ADD_SPLIT";;
...
export_namedthm NSUM_CLAUSES_LEFT "NSUM_CLAUSES_LEFT";;
...
export_namedthm NSUM_CLAUSES_RIGHT "NSUM_CLAUSES_RIGHT";;
...
export_namedthm NSUM_PAIR "NSUM_PAIR";;
...
export_namedthm NSUM_REFLECT "NSUM_REFLECT";;
...
export_namedthm MOD_NSUM_MOD "MOD_NSUM_MOD";;
...
export_namedthm MOD_NSUM_MOD_NUMSEG "MOD_NSUM_MOD_NUMSEG";;
...
export_namedthm CONG_NSUM "CONG_NSUM";;
...
export_theory "set-card-finite-union";;
...
export_namedthm CARD_UNIONS "CARD_UNIONS";;
...
export_namedthm NEUTRAL_REAL_ADD "NEUTRAL_REAL_ADD";;
...
export_namedthm SUM_DEGENERATE "SUM_DEGENERATE";;
...
export_namedthm SUM_CLAUSES "SUM_CLAUSES";;
...
export_namedthm SUM_ADD_GEN "SUM_ADD_GEN";;
...
export_namedthm SUM_EQ_0 "SUM_EQ_0";;

let SUM_0 = prove 
 (`!s:A->bool. sum s (\n. &0) = &0`,
  SIMP_TAC[SUM_EQ_0]);;

export_namedthm SUM_0 "SUM_0";;
...
export_namedthm SUM_NEG "SUM_NEG";;

let SUM_SUB = prove 
 (`!f g s. FINITE s ==> (sum s (\x. f(x) - g(x)) = sum s f - sum s g)`,
  ONCE_REWRITE_TAC[real_sub] THEN SIMP_TAC[SUM_NEG; SUM_ADD]);;

export_namedthm SUM_SUB "SUM_SUB";;
...
export_namedthm SUM_LT_ALL "SUM_LT_ALL";;
...
export_namedthm SUM_POS_LT "SUM_POS_LT";;
...
export_namedthm SUM_POS_LT_ALL "SUM_POS_LT_ALL";;
...
export_namedthm SUM_ABS "SUM_ABS";;
...
export_namedthm SUM_ABS_LE "SUM_ABS_LE";;
...
export_namedthm SUM_CONST "SUM_CONST";;
...
export_namedthm SUM_POS_LE "SUM_POS_LE";;
...
export_namedthm SUM_POS_BOUND "SUM_POS_BOUND";;
...
export_namedthm SUM_POS_EQ_0 "SUM_POS_EQ_0";;
...
export_namedthm SUM_ZERO_EXISTS "SUM_ZERO_EXISTS";;
...
export_namedthm SUM_DELETE "SUM_DELETE";;
...
export_namedthm SUM_DELETE_CASES "SUM_DELETE_CASES";;

let SUM_SING = prove 
 (`!f x. sum {x} f = f(x)`,
  SIMP_TAC[SUM_CLAUSES; FINITE_RULES; NOT_IN_EMPTY; REAL_ADD_RID]);;

export_namedthm SUM_SING "SUM_SING";;
...
export_namedthm SUM_DELTA "SUM_DELTA";;
...
export_namedthm SUM_SWAP "SUM_SWAP";;
...
export_namedthm SUM_IMAGE "SUM_IMAGE";;
...
export_namedthm SUM_SUPERSET "SUM_SUPERSET";;
...
export_namedthm SUM_UNIV "SUM_UNIV";;
...
export_namedthm SUM_UNION_RZERO "SUM_UNION_RZERO";;
...
export_namedthm SUM_UNION_LZERO "SUM_UNION_LZERO";;
...
export_namedthm SUM_RESTRICT "SUM_RESTRICT";;
...
export_namedthm SUM_BOUND "SUM_BOUND";;
...
export_namedthm SUM_BOUND_GEN "SUM_BOUND_GEN";;
...
export_namedthm SUM_ABS_BOUND "SUM_ABS_BOUND";;
...
export_namedthm SUM_BOUND_LT "SUM_BOUND_LT";;
...
export_namedthm SUM_BOUND_LT_ALL "SUM_BOUND_LT_ALL";;
...
export_namedthm SUM_BOUND_LT_GEN "SUM_BOUND_LT_GEN";;
...
export_namedthm SUM_UNION_EQ "SUM_UNION_EQ";;
...
export_namedthm SUM_EQ_SUPERSET "SUM_EQ_SUPERSET";;
...
export_namedthm SUM_RESTRICT_SET "SUM_RESTRICT_SET";;
...
export_namedthm SUM_SUM_RESTRICT "SUM_SUM_RESTRICT";;

let CARD_EQ_SUM = prove 
 (`!s. FINITE s ==> (&(CARD s) = sum s (\x. &1))`,
  SIMP_TAC[SUM_CONST; REAL_MUL_RID]);;

export_namedthm CARD_EQ_SUM "CARD_EQ_SUM";;
...
export_namedthm SUM_MULTICOUNT_GEN "SUM_MULTICOUNT_GEN";;
...
export_namedthm SUM_MULTICOUNT "SUM_MULTICOUNT";;
...
export_namedthm SUM_IMAGE_GEN "SUM_IMAGE_GEN";;
...
export_namedthm SUM_GROUP "SUM_GROUP";;
...
export_namedthm SUM_GROUP_RELATION "SUM_GROUP_RELATION";;
...
export_namedthm REAL_OF_NUM_SUM "REAL_OF_NUM_SUM";;
...
export_namedthm SUM_SUBSET "SUM_SUBSET";;
...
export_namedthm SUM_SUBSET_SIMPLE "SUM_SUBSET_SIMPLE";;
...
export_namedthm SUM_MUL_BOUND "SUM_MUL_BOUND";;
...
export_namedthm SUM_IMAGE_NONZERO "SUM_IMAGE_NONZERO";;
...
export_namedthm SUM_BIJECTION "SUM_BIJECTION";;
...
export_namedthm SUM_SUM_PRODUCT "SUM_SUM_PRODUCT";;
...
export_namedthm SUM_EQ_GENERAL "SUM_EQ_GENERAL";;
...
export_namedthm SUM_EQ_GENERAL_INVERSES "SUM_EQ_GENERAL_INVERSES";;
...
export_namedthm SUM_INJECTION "SUM_INJECTION";;
...
export_namedthm SUM_UNION_NONZERO "SUM_UNION_NONZERO";;
...
export_namedthm SUM_UNIONS_NONZERO "SUM_UNIONS_NONZERO";;
...
export_namedthm SUM_CASES_1 "SUM_CASES_1";;
...
export_namedthm SUM_LE_INCLUDED "SUM_LE_INCLUDED";;
...
export_namedthm SUM_IMAGE_LE "SUM_IMAGE_LE";;
...
export_namedthm SUM_CLOSED "SUM_CLOSED";;
...
export_namedthm SUM_RELATED "SUM_RELATED";;
...
export_namedthm SUM_LE_NUMSEG "SUM_LE_NUMSEG";;
...
export_namedthm SUM_POS_EQ_0_NUMSEG "SUM_POS_EQ_0_NUMSEG";;

let SUM_SING_NUMSEG = prove 
 (`!f n. sum(n..n) f = f(n)`,
  SIMP_TAC[SUM_SING; NUMSEG_SING]);;

export_namedthm SUM_SING_NUMSEG "SUM_SING_NUMSEG";;
...
export_namedthm SUM_CLAUSES_NUMSEG "SUM_CLAUSES_NUMSEG";;
...
export_namedthm SUM_CLAUSES_NUMSEG_LT "SUM_CLAUSES_NUMSEG_LT";;
...
export_namedthm SUM_CLAUSES_NUMSEG_LE "SUM_CLAUSES_NUMSEG_LE";;
...
export_namedthm SUM_SWAP_NUMSEG "SUM_SWAP_NUMSEG";;
...
export_namedthm SUM_ADD_SPLIT "SUM_ADD_SPLIT";;
...
export_namedthm SUM_CLAUSES_LEFT "SUM_CLAUSES_LEFT";;
...
export_namedthm SUM_CLAUSES_RIGHT "SUM_CLAUSES_RIGHT";;
...
export_namedthm SUM_PAIR "SUM_PAIR";;
...
export_namedthm SUM_PARTIAL_SUC "SUM_PARTIAL_SUC";;
...
export_namedthm SUM_PARTIAL_PRE "SUM_PARTIAL_PRE";;
...
export_namedthm SUM_DIFFS "SUM_DIFFS";;
...
export_namedthm SUM_DIFFS_ALT "SUM_DIFFS_ALT";;
...
export_namedthm SUM_COMBINE_R "SUM_COMBINE_R";;
...
export_namedthm SUM_COMBINE_L "SUM_COMBINE_L";;
...
export_theory "algebraic-rearrangements";;
...
export_namedthm REAL_SUB_POW "REAL_SUB_POW";;
...
export_namedthm REAL_SUB_POW_R1 "REAL_SUB_POW_R1";;
...
export_namedthm REAL_SUB_POW_L1 "REAL_SUB_POW_L1";;

(* ------------------------------------------------------------------------- *)
(* Some useful facts about real polynomial functions.                        *)
(* ------------------------------------------------------------------------- *)

export_theory "real-poly-function";;

let REAL_SUB_POLYFUN = prove 
 (`!a:num->real x:real y:real n:num.
    1 <= n
    ==> sum(0..n) (\i:num. a i * x pow i) - sum(0..n) (\i:num. a i * y pow i) =
        (x - y) *
        sum(0..n-1) (\l:num. sum(((l:num) +1)..n) (\k:num. a k * y pow (k - l:num - 1)) * x pow l:num)`,
  REPEAT STRIP_TAC THEN
...
export_namedthm REAL_SUB_POLYFUN "REAL_SUB_POLYFUN";;
...
export_namedthm REAL_SUB_POLYFUN_ALT "REAL_SUB_POLYFUN_ALT";;
...
export_namedthm REAL_POLYFUN_ROOTBOUND "REAL_POLYFUN_ROOTBOUND";;
...
export_namedthm REAL_POLYFUN_FINITE_ROOTS "REAL_POLYFUN_FINITE_ROOTS";;
...
export_namedthm REAL_POLYFUN_EQ_0 "REAL_POLYFUN_EQ_0";;
...
export_namedthm REAL_POLYFUN_EQ_CONST "REAL_POLYFUN_EQ_CONST";;

(* ------------------------------------------------------------------------- *)
(* A general notion of polynomial function.                                  *)
(* ------------------------------------------------------------------------- *)

export_theory "poly-function";;

let polynomial_function = new_definition 
 `polynomial_function p <=> ?m c. !x. p x = sum(0..m) (\i. c i * x pow i)`;;

export_namedthm polynomial_function "polynomial_function";;
...
export_namedthm POLYNOMIAL_FUNCTION_CONST "POLYNOMIAL_FUNCTION_CONST";;
...
export_namedthm POLYNOMIAL_FUNCTION_ID "POLYNOMIAL_FUNCTION_ID";;

let POLYNOMIAL_FUNCTION_I = prove 
 (`polynomial_function I`,
  REWRITE_TAC[I_DEF; POLYNOMIAL_FUNCTION_ID]);;

export_namedthm POLYNOMIAL_FUNCTION_I "POLYNOMIAL_FUNCTION_I";;
...
export_namedthm POLYNOMIAL_FUNCTION_ADD "POLYNOMIAL_FUNCTION_ADD";;
...
export_namedthm POLYNOMIAL_FUNCTION_LMUL "POLYNOMIAL_FUNCTION_LMUL";;
...
export_namedthm POLYNOMIAL_FUNCTION_RMUL "POLYNOMIAL_FUNCTION_RMUL";;
...
export_namedthm POLYNOMIAL_FUNCTION_NEG "POLYNOMIAL_FUNCTION_NEG";;
...
export_namedthm POLYNOMIAL_FUNCTION_SUB "POLYNOMIAL_FUNCTION_SUB";;
...
export_namedthm POLYNOMIAL_FUNCTION_MUL "POLYNOMIAL_FUNCTION_MUL";;
...
export_namedthm POLYNOMIAL_FUNCTION_SUM "POLYNOMIAL_FUNCTION_SUM";;
...
export_namedthm POLYNOMIAL_FUNCTION_POW "POLYNOMIAL_FUNCTION_POW";;
...
export_namedthm POLYNOMIAL_FUNCTION_INDUCT "POLYNOMIAL_FUNCTION_INDUCT";;
...
export_namedthm POLYNOMIAL_FUNCTION_o "POLYNOMIAL_FUNCTION_o";;
...
export_namedthm POLYNOMIAL_FUNCTION_FINITE_ROOTS "POLYNOMIAL_FUNCTION_FINITE_ROOTS";;
